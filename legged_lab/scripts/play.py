...
def play():
    ...
    # Allow velocity to vary during play mode
    env_cfg.commands.ranges.lin_vel_x = (1.0, 1.0)
    env_cfg.commands.ranges.lin_vel_y = (0.0, 0.0)
    env_cfg.commands.ranges.ang_vel_z = (0.0, 0.0)
    # env_cfg.commands.ranges.lin_vel_x = (-0.6, 1.0)
    # env_cfg.commands.ranges.lin_vel_y = (-0.6, 1.0)
    # env_cfg.commands.ranges.ang_vel_z = (-0.6, 1.0)
    # Make velocity change more frequently (every 5-8 seconds instead of 10 seconds)
    env_cfg.commands.resampling_time_range = (3.0, 5.0)
